...
#                                                                                                         #
# Requirements:  Windows PowerShell 5.1 (Windows Server 2019)                                 #
#                                                                                                         #
# Usage:                                                                                                  #
#  PowerShell -NoProfile -ExecutionPolicy Bypass -File C:\{Path2Script}\sendReports.ps1      #
#                                                                                                         #
# Usage example:                                                                                          #
#  PowerShell -NoProfile -ExecutionPolicy Bypass `             #
#             -File "C:\monthlyReporting\sendReports.ps1"                                              #
#                                                                                                         #
